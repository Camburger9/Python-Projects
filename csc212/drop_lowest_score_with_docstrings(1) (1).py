...
def get_scores():
    ...
    Precondition: This method does not expect any argument as parameter.
    Postcondition: This method inputs float values into a list and returns the list.
    '''
...
def get_total(value_list):
    ...
    Precondition: It expects a numeric list as incoming parameter
    Postcondition: It returns the total.
    '''
